...
export const metadata: Metadata = { title: 'Entrega | inGarage', description: 'Saiba como o frete é calculado e apresentado nos pedidos da inGarage.' };
...
export default function DeliveryPage() {
  return <InstitutionalPage eyebrow="AJUDA" title="Entrega" introduction="O frete é cotado durante o checkout a partir dos dados do pedido. Valores e estimativas desta página não são fixos: prevalecem os dados confirmados pelo backend em cada compra." sections={[
    { title: 'Cálculo do frete', content: <p>Depois que um endereço válido é selecionado e há itens no carrinho, a inGarage envia ao backend o CEP, os identificadores dos produtos e as quantidades. As opções disponíveis retornam com nome, preço e estimativa em dias. O cliente escolhe uma opção antes de finalizar.</p> },
