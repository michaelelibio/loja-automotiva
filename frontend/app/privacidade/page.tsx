...
export const metadata: Metadata = {
  title: 'Política de Privacidade | inGarage',
  description: 'Entenda como a inGarage trata dados pessoais durante o uso da loja, compras, pagamentos e entregas.',
};

export default function PrivacyPage() {
  return <InstitutionalPage eyebrow="LEGAL" title="Política de Privacidade" reviewNotice introduction="Este documento explica, de forma transparente, como os dados pessoais necessários ao funcionamento da inGarage são tratados." sections={[
    ...
    { title: 'Pagamentos', content: <p>Os pagamentos online são iniciados pelo backend da inGarage e concluídos no ambiente hospedado do Mercado Pago. A inGarage mantém somente os identificadores e estados necessários para conciliar o pedido; dados completos de cartão não são coletados nem armazenados pela loja.</p> },
